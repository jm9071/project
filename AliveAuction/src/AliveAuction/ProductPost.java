...
public class ProductPost {
	...
	private void initialize() {
		...
		panel_1.setBounds(91, 104, 79, 36);
		...
		panel_2.setBounds(182, 104, 390, 36);
		...
		lab_productPostImage.setBounds(91, 150, 481, 148);
		frame.getContentPane().add(lab_productPostImage);

		JPanel panel_5 = new JPanel();
		panel_5.setBounds(461, 308, 111, 23);
		...
		panel_6.setBounds(183, 365, 389, 123);
		...
		panel_7.setBounds(81, 365, 90, 36);
		...
		panel_8.setBounds(81, 319, 90, 36);
		...
		panel_9.setBounds(184, 319, 133, 36);
		...
		panel_24.setBounds(149, 671, 176, 43);
		frame.getContentPane().add(panel_24);
		panel_24.setLayout(new CardLayout(0, 0));

		JButton btn_productPost = new JButton("\uB4F1\uB85D");
		btn_productPost.setBackground(Color.WHITE);
		btn_productPost.setIcon(new ImageIcon("C:\\Users\\SM18\\Desktop\\\uC5BC\uB77C\uC774\uBE0C\uC625\uC158\\\uBC84\uD2BC\uC774\uBBF8\uC9C0\\\uBC84\uD2BC_\uB4F1\uB85D2.png"));
		btn_productPost.setOpaque(false);
		btn_productPost.setBorderPainted(false);
		...
		panel_25.setBounds(343, 671, 176, 43);
		frame.getContentPane().add(panel_25);
		panel_25.setLayout(new CardLayout(0, 0));

		JButton btn_productPostClose = new JButton("\uB2EB\uAE30");
		btn_productPostClose.setIcon(new ImageIcon("C:\\Users\\SM18\\Desktop\\\uC5BC\uB77C\uC774\uBE0C\uC625\uC158\\\uBC84\uD2BC\uC774\uBBF8\uC9C0\\\uBC84\uD2BC_\uB4F1\uB85D_\uB2EB\uAE30.png"));
		btn_productPostClose.setOpaque(false);
		btn_productPostClose.setBorderPainted(false);
