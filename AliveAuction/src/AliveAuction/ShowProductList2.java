...
public class ShowProductList2 {
	...
	private void initialize() {
		...
		btnNewButton_1.setIcon(new ImageIcon("C:\\Users\\SM18\\Desktop\\얼라이브옥션\\버튼이미지\\버튼_로그인_닫기.png"));
...
//		}
	...
	public void add(SpringLayout springLayout,ProductVO vo) {
		...
		JPanel panel = new JPanel();
		panel.setPreferredSize(new Dimension(200,80)); // 크기정하는거
		...
		btnNewButton.setIcon(new ImageIcon("C:\\Users\\SM18\\Desktop\\얼라이브옥션\\버튼이미지\\버튼_구매하기_리스트.png"));
		btnNewButton.setPreferredSize(new Dimension(110,35));
