...
public class Join {
	...
	private void initialize() {
				...
				String id = txt_joinId.getText();
			      ...
			      if (pw.equals(pwCheck)) {
			         ...
			         if (result == 0) {
			            ...
			            JOptionPane.showMessageDialog(null, "비밀번호가 일치하지 않습니다.", "비밀번호 확인", JOptionPane.ERROR_MESSAGE);
			      }
			      
			}
		});
		btn_join.setFont(new Font("나눔고딕", Font.PLAIN, 15));
		...
		btn_joinClose.setFont(new Font("나눔고딕", Font.PLAIN, 15));
